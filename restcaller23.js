...
(function() {
  ...
  var cardcreated = jsonvalue['id'];
    ...
    arr[1][0]=document.getElementById('key-val');
    arr[1][1]=document.getElementById('customfield_10476-val');
    arr[1][2]=document.getElementById('customfield_10361-val');
    arr[1][3]=document.getElementById('customfield_10363');
    arr[1][4]=document.getElementById('customfield_10806');
    arr[1][5]=document.getElementById('field-customfield_11408');
    arr[1][6]=document.getElementById('type-val');
    arr[1][7]=document.getElementById('status-val');
    arr[1][8]=document.getElementById('reporter-val');
    arr[1][9]=document.getElementById('customfield_10376-val');
    arr[1][10]=document.getElementById('customfield_10377-val');
    arr[1][11]=document.getElementById('customfield_10366-val');
    arr[1][12]=document.getElementById('description-val');
    arr[1][13]=document.getElementById('customfield_10392-val');
    arr[1][14]=document.getElementById('customfield_10361-val');
